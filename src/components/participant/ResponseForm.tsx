        ...
        <span aria-hidden="true">✍️</span> Your Response
          ...
          <div>
            ...
            <textarea
              ...
              aria-required="true"
              aria-describedby="alternative-thought-counter"
            />
            <div id="alternative-thought-counter" className={`text-right text-xs mt-1 ${alternativeThought.length > 450 ? 'text-red-600 font-bold' : 'text-gray-500'}`}>
          ...
          <div>
            ...
            <textarea
              ...
              aria-describedby="automatic-thought-counter"
            />
            <div id="automatic-thought-counter" className={`text-right text-xs mt-1 ${automaticThought.length > 450 ? 'text-red-600 font-bold' : 'text-gray-500'}`}>
