        ...
        <span aria-hidden="true">✍️</span> Your Response
          ...
          <div>
            ...
            <div
              ...
              className={`text-right text-xs mt-1 ${alternativeThought.length >= 300 ? 'text-red-600 font-bold' : alternativeThought.length >= 240 ? 'text-orange-700 font-medium' : 'text-gray-500'}`}
              aria-hidden="true"
            >
