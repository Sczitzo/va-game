          ...
          <div>
            ...
            <div
              ...
              className={`text-right text-xs mt-1 ${
                alternativeThought.length >= 270 ? 'text-red-600 font-bold' :
                alternativeThought.length >= 240 ? 'text-orange-700 font-medium' :
                'text-gray-500'
              }`}
            >
            ...
            <div className="sr-only" role="status">
              {alternativeThought.length >= 240 ? 'Approaching character limit' : ''}
            </div>
          </div>
