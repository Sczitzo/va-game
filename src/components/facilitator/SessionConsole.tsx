        ...
        {sessionState.status !== 'ENDED' && (
          <div className="flex flex-col gap-2">
            <button
              ...
              className={`w-full px-4 py-2 text-white rounded-lg transition-colors focus-visible-ring ${
                showEndConfirm
                  ? 'bg-red-800 hover:bg-red-900 font-bold ring-2 ring-red-500 ring-offset-2'
            ...
            {showEndConfirm && (
              <p className="text-xs text-red-700 font-medium text-center animate-in fade-in slide-in-from-top-1">
