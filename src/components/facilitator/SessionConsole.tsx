      ...
      <div className="space-y-2 pt-4 border-t">
        ...
        {sessionState.status !== 'ENDED' && (
          <button
            ...
            className={
              showEndConfirm
                ? "w-full px-4 py-2 bg-red-50 border-2 border-red-500 text-red-600 hover:bg-red-500 hover:text-white font-bold rounded-lg focus-visible-ring transition-colors duration-200"
