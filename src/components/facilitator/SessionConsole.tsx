        ...
        {sessionState.status !== 'ENDED' && (
          <div className="space-y-2">
            <button
              ...
              className={
                isConfirmingEnd
                  ? "w-full px-4 py-2 font-bold bg-red-700 text-white rounded-lg hover:bg-red-800 focus-visible-ring"
                  : "w-full px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 focus-visible-ring"
              }
            >
