        ...
        {sessionState.status !== 'ENDED' && (
          <div className="space-y-2">
            ...
            <button
              ...
              className={
                showEndConfirm
                  ? 'w-full px-4 py-2 bg-red-50 border-2 border-red-600 text-red-700 font-bold rounded-lg hover:bg-red-600 hover:text-white focus-visible-ring transition-colors duration-200'
