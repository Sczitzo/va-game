...
## 2026-02-20 - Dynamic Character Feedback
**Learning:** Constant `aria-live` updates on character counters spam screen readers on every keystroke.
**Action:** Only activate `aria-live="polite"` when approaching the limit (>80%) to balance feedback with usability.
