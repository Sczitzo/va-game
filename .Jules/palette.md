...
## 2026-10-25 - Accessible Character Limits
**Learning:** Dynamic text changes inside persistently rendered elements with aria-live create noisy screen reader announcements for character limits. Premature "limit reached" messages at warning thresholds are mathematically inaccurate and confusing.
**Action:** Render strictly static, visually hidden elements conditionally to announce threshold crossings, and ensure "limit reached" only triggers at exactly 100% capacity.
